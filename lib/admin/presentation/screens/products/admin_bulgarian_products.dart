...
class AdminBulgarianProducts extends StatelessWidget {
  const AdminBulgarianProducts({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Cars Admin Page',style: TextStyle(color: Colors.yellow),),
